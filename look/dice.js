...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-01c7a012');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-01c7a012');}
...
var brandEl=document.querySelector('.rl-brand-01c7a012');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
